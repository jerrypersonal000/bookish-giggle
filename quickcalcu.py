...
# Input fields
st.session_state.A = st.number_input("Enter the initial value A: ", step=1, value=st.session_state.A if st.session_state.A is not None else 0)
st.session_state.B = st.number_input("Enter the lower bound B: ", step=1, value=st.session_state.B if st.session_state.B is not None else 0)
st.session_state.C = st.number_input("Enter the upper bound C: ", step=1, value=st.session_state.C if st.session_state.C is not None else 0)
